...
parser.add_argument('--node_num', type=int, default=34,
                    help='number of epochs to train')
parser.add_argument('--node_size', type=int, default=34,
                    help='number of epochs to train')
parser.add_argument("--seed",type =int,default = 134,help = "random seed (default: 2050)")
...
# karate 
adj_address = '/data/chenmy/voter/seed2051karate341000-adjmat.pickle'
series_address = '/data/chenmy/voter/seed2051karate341000-series.pickle'
